import './logo.scss';
import B from '/home/llcheeto/portfolio/src/assets/images/B.png';
  ...
  useEffect(() => {
	...
	return (
      	<div className="logo-container" ref={bgRef}>
        	<img ref={solidLogoRef} className="solid-logo" src={B} alt="B" />

				<svg
					   version="1.0"
						 width="140"
						 height="150"
						 viewBox="80 130 500 500"
